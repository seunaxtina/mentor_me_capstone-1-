...
print("Committing...")
res_commit = subprocess.run([git_bin, "commit", "-m", "refactor: remove 'Not stated' option from gender selectbox in profile setup"], cwd=repo_dir, capture_output=True, text=True)
